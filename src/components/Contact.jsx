          ...
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="bg-primary p-3 border border-white/10 group-hover:border-accent transition-colors">
                  <MapPin className="text-accent w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-sm text-gray-400 mb-1">Location</h4>
                  <p className="text-lg">123 Fitness Ave, Iron District, NY 10001</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-sm text-gray-400 mb-1">Phone</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-sm text-gray-400 mb-1">Email</h4>
                  <p className="text-lg">join@fitfusion.com</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {submitStatus && (
              <motion.div
                ...
                className={`p-4 mt-2 border ${submitStatus === 'success' ? 'bg-green-500/10 border-green-500/30 text-green-400' : 'bg-red-500/10 border-red-500/30 text-red-400'}`}
              >
                {submitMessage}
              </motion.div>
            )}
